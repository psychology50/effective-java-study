...
|55. 옵셔널 반환은 신중히 하라| [안형준](https://com-squadleader.tistory.com/272) |
|56. 공개된 API 요소에는 항상 문서화 주석을 작성하라| [조예림](https://joyerim.tistory.com/101) |

## 9장. 일반적인 프로그래밍 원칙  

|아이템|발표자|
|:---|:---:|
|57. 지역변수의 범위를 최소화하라|[양재서](https://jaeseo0519.tistory.com/247)|
|58. 전통적인 for문보다는 for-each문을 사용하라|[양재서](https://jaeseo0519.tistory.com/248)|
|59. 라이브러리를 익히고 사용하라|[조예림](https://joyerim.tistory.com/104)|
|60. 정확한 답이 필요하다면 float와 double은 피하라|[안형준](https://com-squadleader.tistory.com/277)|
|61. 박싱된 기본 타입보다는 기본 타입을 사용하라|[양재서](https://jaeseo0519.tistory.com/255)|
|62. 다른 타입이 적절하다면 문자열 사용을 피하라|[조예림](https://joyerim.tistory.com/111)|
|63. 문자열 연결은 느리니 주의하라|[안형준](https://com-squadleader.tistory.com/282)|
|64. 객체는 인터페이스를 사용해 참조하라|[조예림](https://joyerim.tistory.com/113)|
|65. 리플렉션보다는 인터페이스를 사용하라|[양재서](https://jaeseo0519.tistory.com/267)|
|66. 네이티브 메서드는 신중히 사용하라|[안형준](https://com-squadleader.tistory.com/285)|
|67. 최적화는 신중히 하라|[안형준](https://com-squadleader.tistory.com/287)|
|68. 일반적으로 통용되는 명명 규칙을 따르라|[조예림](https://joyerim.tistory.com/119)|

## 10장. 예외  

|아이템|발표자|
|:---|:---:|
|69. 예외는 진짜 예외 상황에만 사용하라|[양재서](https://jaeseo0519.tistory.com/276?category=1131919)|
|70. 복구할 수 있는 상황에는 검사 예외를, 프로그래밍 오류에는 런타임 예외를 사용하라|[양재서](https://jaeseo0519.tistory.com/278)|
|71. 필요 없는 검사 예외 사용은 피하라|[안형준](https://com-squadleader.tistory.com/292)|
|72. 표준 예외를 사용하라|[조예림](https://joyerim.tistory.com/123)|
|73. 추상화 수준에 맞는 예외를 던져라|[양재서](https://jaeseo0519.tistory.com/285)|
|74. 메서드가 던지는 모든 예외를 문서화하라|[안형준](https://com-squadleader.tistory.com/298)|
|75. 예외의 상세 메시지에 실패 관련 정보를 담으라|[조예림](https://joyerim.tistory.com/126)|
|76. 가능한 한 실패 원자적으로 만들라|[안형준](https://com-squadleader.tistory.com/301)|
|77. 예외를 무시하지 말라|[조예림](https://joyerim.tistory.com/128)|

## 11장. 동시성  

|아이템|발표자|
|:---|:---:|
|78. 공유 중인 가변 데이터는 동기화해 사용하라|[양재서](https://jaeseo0519.tistory.com/298?category=1131919)|
|79. 과도한 동기화는 피하라|[조예림](https://joyerim.tistory.com/130)|
|80. 스레드보다는 실행자, 태스크, 스트림을 애용하라|[안형준](https://com-squadleader.tistory.com/305?category=1093428)|
|81. wait와 notify보다는 동시성 유틸리티를 애용하라|[양재서](https://jaeseo0519.tistory.com/301)|
|82. 스레드 안정성 수준을 문서와하라|[]()|
|83. 지연 초기화는 신중히 사용하라|[]()|
